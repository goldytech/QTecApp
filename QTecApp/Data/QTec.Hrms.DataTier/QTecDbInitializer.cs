namespace QTec.Hrms.DataTier
{
    ...
    public class QTecDbInitializer : DropCreateDatabaseIfModelChanges<QTecDataContext>
    {
        ...
        {
            dataContext.Designations.Add(new Designation { Id = 1, Name = "Software Engineer" });
            dataContext.Designations.Add(new Designation { Id = 2, Name = "Sr. Software Engineer" });
            dataContext.Designations.Add(new Designation { Id = 3, Name = "Software Trainee" });
            dataContext.Designations.Add(new Designation { Id = 4, Name = "Team Lead" });
            dataContext.Designations.Add(new Designation { Id = 5, Name = "Tech Lead" });
            dataContext.Designations.Add(new Designation { Id = 6, Name = "QA Engineer" });
